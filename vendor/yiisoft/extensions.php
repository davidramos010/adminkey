...
return array (
  ...
  array (
    'name' => 'bethrezen/yii2-cached-rbac-dbmanager',
    'version' => 'dev-master',
    'alias' => 
    array (
      '@bethrezen' => $vendorDir . '/bethrezen/yii2-cached-rbac-dbmanager',
    ),
  ),
  ...
  array (
    'name' => 'factorenergia/yii2-activerecord-history',
    'version' => '1.2.0.0',
    'alias' => 
    array (
      '@nhkey/arh' => $vendorDir . '/factorenergia/yii2-activerecord-history/src',
    ),
  ),
  ...
  array (
    'name' => 'krisengine/yii2-graylog2',
    'version' => 'dev-master',
    'alias' => 
    array (
      '@krisengine/graylog' => $vendorDir . '/krisengine/yii2-graylog2',
    ),
  ),
