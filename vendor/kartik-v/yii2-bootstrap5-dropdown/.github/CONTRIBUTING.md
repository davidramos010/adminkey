Contributing to yii2-bootstrap5-dropdown
=================================
Looking to contribute something to yii2-bootstrap5-dropdown? **Here's how you can help.**
...
[extension documentation and demos](http://demos.krajee.com/bootstrap5-dropdown) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-bootstrap5-dropdown
-------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-bootstrap5-dropdown_.
...
- What version of jQuery are you using? And what version of yii2-bootstrap5-dropdown?
- Are you using yii2-bootstrap5-dropdown with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-bootstrap5-dropdown
----------------------------------------
Before starting work on a major feature for yii2-bootstrap5-dropdown, **read the
[documentation](http://demos.krajee.com/bootstrap5-dropdown)  first** or you may risk spending a considerable amount of
...
yii2-bootstrap5-dropdown regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-bootstrap5-dropdown that contain test cases and
...
It should also be made clear that **all code contributed to yii2-bootstrap5-dropdown** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[issue-search]: https://github.com/kartik-v/yii2-bootstrap5-dropdown/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/yii2-bootstrap5-dropdown/issues
[licensing]: https://github.com/kartik-v/yii2-bootstrap5-dropdown/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-bootstrap5-dropdown
[requesting-features]: #requesting-features-in-yii2-bootstrap5-dropdown